      ...
      {width > 0 && (
        <div>
          <StaticVideoBG
            video={
              width > 0 && width > 700
                ? `https://orange-generous-tern-256.mypinata.cloud/ipfs/QmQ52DBkSJiLVnWcY6hNWTyxRfWAQaaN4s2sAVg6hVDHq9`
                : `https://orange-generous-tern-256.mypinata.cloud/ipfs/QmQoHrAUGfpFnddEYSquKHukLsDN74YhFk9jtsPj33igzE`
            }
          />
          <div
            ...
            style={{
              ...
              alignContent: "center",
              height: "100%",
              backgroundColor: width > 700 ? "#00000095" : "",
            }}>
            <Row className="justify-content-center mx-3 mx-lg-10">
              ...
              {width < 900 && (
                <div className="text-center mt-5">
                  ...
                  <p className="text-white fs-5 pb-5">
