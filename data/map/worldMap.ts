type Coordinate = [number, number]; // Latitude and Longitude tuple
type Arc = Coordinate[]; // Array of coordinates representing an arc

interface Geometry {
  type: "Polygon" | "MultiPolygon"; // Types of geometry
  arcs: number[][][] | number[][]; // Nested arrays of arc indices
...
interface WorldMapType {
  type: "Topology"; // Type of the map structure
  objects: {
    world: {
