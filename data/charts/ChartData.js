const theme = {
  ...
  black: "var(--fc-black)",
  lightPrimary: "var(--fc-light-primary)",
  lightSecondary: "var(--fc-light-secondary)",
  lightSuccess: "var(--fc-light-success)",
  lightDanger: "var(--fc-light-danger)",
  lightWarning: "var(--fc-light-warning)",
  lightInfo: "var(--fc-light-info)",
  darkPrimary: "var(--fc-dark-primary)",
  darkSecondary: "var(--fc-dark-secondary)",
  darkSuccess: "var(--fc-dark-success)",
  darkDanger: "var(--fc-dark-danger)",
  darkWarning: "var(--fc-dark-warning)",
  darkInfo: "var(--fc-dark-info)",
